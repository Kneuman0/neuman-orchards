---
name: ecoag-wild-integration
description: Use this skill when the user needs domain-specific ecological agriculture reasoning from `G:\My Drive\Home Docs\Garden\knowledgebase\11_wild_plants_foraged_integration`, especially for edible wild plants, managed foraged-plant inclusion, wild-to-garden transfer, and edible green infrastructure.
---

# EcoAg Wild Integration

## Overview

This local specialist skill owns reasoning for `11_wild_plants_foraged_integration` in the ecological agriculture knowledgebase. It should answer from this domain first, using the local literature in `G:\My Drive\Home Docs\Garden\knowledgebase\11_wild_plants_foraged_integration` and the attached expert brief.
...
- Primary folder scope: `G:\My Drive\Home Docs\Garden\knowledgebase\11_wild_plants_foraged_integration`
...
- `references/expert-brief.md`
  Domain brief for `11_wild_plants_foraged_integration`.
- `references/taxonomy.md`
  Retrieval-oriented map of themes, question-routing patterns, source inventory, search cues, and weak-evidence areas for this skill's local literature.
