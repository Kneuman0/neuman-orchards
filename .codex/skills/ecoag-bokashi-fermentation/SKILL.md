---
name: ecoag-bokashi-fermentation
description: Use this skill when the user needs domain-specific ecological agriculture reasoning from `G:\My Drive\Home Docs\Garden\knowledgebase\04_bokashi_em`, especially for bokashi fermentation, EM-style management, LAB fermentation, and fermentation-based nutrient cycling.
---

# EcoAg Bokashi Fermentation

## Overview

This local specialist skill owns reasoning for `04_bokashi_em` in the ecological agriculture knowledgebase. It should answer from this domain first, using the local literature in `G:\My Drive\Home Docs\Garden\knowledgebase\04_bokashi_em` and the attached expert brief.
...
- For process or troubleshooting questions about how to actually run bokashi step by step, read `references/bokashi-sequence.md` after `references/taxonomy.md` and before deeper paper review.
...
- Primary folder scope: `G:\My Drive\Home Docs\Garden\knowledgebase\04_bokashi_em`
- Read `references/expert-brief.md` before answering.
- Read `references/taxonomy.md` before answering, and use it to route the question to the most relevant local source file(s) before deeper reading.
...
- `references/expert-brief.md`
  Domain brief for `04_bokashi_em`.
- `references/taxonomy.md`
  Retrieval-oriented map of themes, question-routing patterns, source inventory, search cues, and weak-evidence areas for this domain.
- `references/bokashi-sequence.md`
  Process-oriented guide to bokashi sequence, mechanism, moisture and oxygen logic, fermentation timing, and post-fermentation routing into soil or compost systems.
