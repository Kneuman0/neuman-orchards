---
name: ecoag-biochar
description: Use this skill when the user needs domain-specific ecological agriculture reasoning from `G:\My Drive\Home Docs\Garden\knowledgebase\03_biochar`, especially for biochar production and use, especially where it intersects with composting, nutrient retention, disease suppression, and crop response.
---
...
This local specialist skill owns reasoning for `03_biochar` in the ecological agriculture knowledgebase. It should answer from this domain first, using the local literature in `G:\My Drive\Home Docs\Garden\knowledgebase\03_biochar` and the attached expert brief.
...
- Primary folder scope: `G:\My Drive\Home Docs\Garden\knowledgebase\03_biochar`
